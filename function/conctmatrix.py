...
xlsfiles = [r'I:\Git Hub\ECG clssi\database\200_180 data\fusion.xlsx', r'I:\Git Hub\ECG clssi\database\200_180 data\normal.xlsx']
outrow_idx = 0
for f in xlsfiles:
...
wkbk.save(r'I:\Git Hub\ECG clssi\ECG code\combine.csv')
print wkbk
