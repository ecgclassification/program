...
img7 = PhotoImage(file="MAT.gif")
canvas.create_image(530,-250, anchor=NW, image=img7)

img8 = PhotoImage(file="MAT.gif")
canvas.create_image(530,-130, anchor=NW, image=img8)
